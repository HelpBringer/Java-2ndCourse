...
public class Student implements Serializable {
    ...
    private static Node getStudent(Document doc, Student student){
        ...
        // элементы
        stud.appendChild(getStudentElements(doc, stud, "surname", student.surname));
        stud.appendChild(getStudentElements(doc, stud, "name", student.name));
        stud.appendChild(getStudentElements(doc, stud, "mark",  Double.toString(student.mark)));
        stud.appendChild(getStudentElements(doc, stud, "height", Integer.toString(student.height)));
        return stud;
    }
